...
public sealed class RabbitMqOptions
{
    ...
    [Range(0, 10)]
    public int PublishRetryCount { get; init; } = 2;

    [Range(1, 60_000)]
    public int InitialPublishRetryDelayMilliseconds { get; init; } = 200;

    [Range(1, 100)]
    public int PublishCircuitBreakerFailures { get; init; } = 3;

    [Range(1, 3_600)]
    public int PublishCircuitBreakDurationSeconds { get; init; } = 30;
