...
public sealed class Order
{
    ...
    {
        EnsureDefined(orderStatus, nameof(orderStatus));
        EnsureDefined(paymentStatus, nameof(paymentStatus));
        EnsureDefined(fulfillmentStatus, nameof(fulfillmentStatus));
        ...
        where TEnum : struct, Enum
    {
        ...
        {
            throw new ArgumentOutOfRangeException(parameterName, value, $"{typeof(TEnum).Name} value is not defined.");
        }
    }
}
